  ...
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center" data-toggle="gridmenu">
        <img class="navbar-brand-logo" src="<?= base_url(''); ?>assets/logo/logostd.png" title="Remark">
        <span class="navbar-brand-text"> Manajemen Standar</span>
      </div>
    </div>
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right mx-15">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" role="menu">
              ...
              <p class="text-center"><?php echo $this->session->userdata('nama_rev');  ?></p>
